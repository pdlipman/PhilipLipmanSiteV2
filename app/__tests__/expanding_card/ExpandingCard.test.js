...
describe('ExpandingCard', () => {
    ...
    test('loads properly', () => {
        ...
        let initialCard = TestUtils.scryRenderedDOMComponentsWithClass(component, 'initial-card-interior');
        expect(component.state.expand).toBe(false);

        TestUtils.Simulate.click(initialCard[0]);
